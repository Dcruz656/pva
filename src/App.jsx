          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm">
              <thead className="bg-surface-container-high border-b border-outline-variant">
                <tr>
                  {["Evaluación", "Variable", "Dimensión", "Claridad", "Relevancia", "Coherencia", "Estado", "Fecha"].map((h) => (
...
export default function App({ onLogout }) {
  ...
  return (
    <div className="bg-background text-on-surface flex flex-col min-h-screen">
      ...
      {/* ── Main ── */}
      <main className="flex-1 mt-16 xl:ml-64 p-10 overflow-y-auto">
        <div className="max-w-[1200px] mx-auto">
          ...
          {view === "crear-evaluacion" && (
            <CrearEvaluacion
              ...
              onCreated={() => setView("evaluaciones")}
            />
          )}
